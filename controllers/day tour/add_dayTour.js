...
const AddDayTour = (req,res) =>{
    ...
    const{daytour,description,price, places} = req.body;
    let img = "null"
    ...
    if(daytour!==''&& description!==''&&price!==''&& places!==''){
        ...
        const query = `INSERT INTO day_tour (day_tour_id,day_tour,description,price,img) VALUES ('${Id}','${daytour}','${description}','${price}','${img}')`;
            ...
            if(err){
                ...
                if(places && places.length >0){
                    places.forEach(place => {
                        const placequery = `INSERT INTO day_tour_places (day_tour_id,place_id) VALUES ('${Id}','${place}')`;
